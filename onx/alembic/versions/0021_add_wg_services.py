...
def upgrade() -> None:
    wg_service_state = sa.Enum("planned", "applying", "active", "failed", "deleted", name="wg_service_state")
    ...
    op.create_foreign_key(None, "peers", "wg_services", ["wg_service_id"], ["id"], ondelete="SET NULL")
